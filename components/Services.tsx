...
export default function Services() {
  return (
    <section id="services" className="pt-24 flex flex-col gap-24">
      ...
      <div className="flex flex-col lg:flex-row">
        <div className="flex flex-col w-full lg:w-1/2">
          ...
          <div className="px-4 md:px-6 pt-4 pb-16 flex flex-col gap-4 lg:border-r-[.5px] border-[#7f7f7f]">
            <label htmlFor="service-design" className="text-3xl uppercase">
              Design
            </label>
            <div className="flex gap-12">
              <div className="flex flex-col">
                <p className={`${GeistMono.className} text-[#7f7f7f]`}>
                  UI UX Design
                </p>
                <p className={`${GeistMono.className} text-[#7f7f7f]`}>
                  Moible App Design
